      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-end mb-12">
          <div>
            ...
            <p className="text-gray-600">Inspirations, conseils et guides pour vos prochaines aventures</p>
          </div>
          <button className="hidden md:flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          {blogPosts.filter(post => post.featured).map(post => (
            <div key={post.id} className="group relative overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-2xl transition-all duration-300">
        ...
        <button className="w-full md:hidden mt-8 flex items-center justify-center gap-2 text-blue-600 hover:text-blue-700 transition-colors">
          <span className="font-medium">Voir tous les articles</span>
