...
import { Utensils, Landmark, Activity, ShoppingBag } from 'lucide-react';
...
export default function HotelNearby({ restaurants, attractions, activities, shopping }: HotelNearbyProps) {
  return (
