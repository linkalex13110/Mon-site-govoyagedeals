...
export default function OfferBookingCard({ price, onBook }: OfferBookingCardProps) {
  return (
    <div className="hidden lg:block sticky top-6">
      <div className="bg-white rounded-2xl shadow-lg p-8">
        ...
        <button
          onClick={onBook}
          className="w-full px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors mb-6"
        >
          Réserver maintenant
        </button>
